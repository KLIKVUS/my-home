...
function Nav({ panelIcon }) {
    ...
    const handelPanelActivation = () => {
        document.getElementsByTagName("body")[0].style.overflowY = !panelIsActive ? "hidden" : "auto";
    ...
    return (
        <div className={panelIsActive ? "panel-wrapper--open" : "panel-wrapper"}>
            <div className="panel">
                <div className="panel__icons-wrapper">
                    ...
                    <div className="panel__icon panel__btn-icon">
                        <button className={["panel__btn", "btn", panelIsActive ? "btn--close" : null].join(" ")} onClick={handelPanelActivation}>
                ...
                <div className="panel__links-wrapper">
                    ...
                    <nav className="panel__nav nav">
                        <NavLink to="/works" className="nav__link" onClick={handelPanelActivation}>Works</NavLink>
                        <NavLink to="/feedbacks" className="nav__link" onClick={handelPanelActivation}>Feedbacks</NavLink>
                        <NavLink to="/about" className="nav__link" onClick={handelPanelActivation}>About</NavLink>
                    </nav>
                </div>
